...
import type { ScheduleFormType } from "@/lib/schemas/zodSchemas";
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem className="mt-4">
							...
							<FormDescription>
								You can <span className="font-extrabold">@mention</span> and{" "}
								<span className="font-extrabold">#hashtag</span> just like you
								would on the platform you&apos;re posting to.
							</FormDescription>
							<FormMessage />
						</FormItem>
					)}
