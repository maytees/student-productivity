	...
	"inline-flex items-center whitespace-nowrap justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0",
	{
		...
		compoundVariants: [
			/* Light */
			{
				...
				appearance: "light",
				className:
					"text-[var(--color-primary-accent,var(--color-cyan-700))] bg-[var(--color-primary-soft,var(--color-cyan-50))] dark:bg-[var(--color-primary-soft,var(--color-cyan-950))] dark:text-[var(--color-primary-soft,var(--color-cyan-600))]",
			},
			{
				variant: "secondary",
				appearance: "light",
			...
			/* Outline */
			{
				...
				appearance: "outline",
				className:
					"text-[var(--color-primary-accent,var(--color-cyan-700))] border-[var(--color-primary-soft,var(--color-cyan-100))] bg-[var(--color-primary-soft,var(--color-cyan-50))] dark:bg-[var(--color-primary-soft,var(--color-cyan-950))] dark:border-[var(--color-primary-soft,var(--color-cyan-900))] dark:text-[var(--color-primary-soft,var(--color-cyan-600))]",
			},
			{
				variant: "success",
				appearance: "outline",
